        ...
        <>
            <div className="flex flex-wrap flex-column text-justify pt-36 h-screen" id="infoAbout">
                <div className="w-screen xl:w-1/3"><h1 className="text-center text-3xl">Kdo <span className="font-thin">jsem.</span></h1>
                    <p className="w-2/3 pt-8 mx-auto text-justify">Pokud si tohle čtete, tak se Vám nejspíš již pod ruku dostal můj životopis, se kterým jste se určitě dobře seznámily. Tak si to zkusíme ještě sumarizovat do kondenzovaného bloku textu.
                    </p>
                    ...
                    <p className="w-2/3 pt-8 mx-auto text-justify">V průběhu svých studií jsem taky získal hromadu praktických zkušeností při part-time jobech a odborných stážích, z nichž nejpřínosnější pro mě byla odborná stáž pro Alza.cz 
                    </p>
                ...
                <p className="w-2/3 pt-8 mx-auto">Co se týče technologií, se kterými to umím, tak to lze shrnout následovně... <strong>Styluju</strong> v CSS, Tailwindu a Bootstrapu. Webovky <strong>píšu</strong> v HTML a JavaScriptu, pracuji s různými knihovnami a frameworky jako třeba React a NextJS (takže taky JSX/TSX). Neztratím se ani v SQL databázích, používám technologie jako PostgreSQL nebo SQLite.</p>
