...
export const ProductRow: FunctionComponent<Props> = (props) => {
    ...
    return(
      ...
      { visible &&
        <>
        <div className="border-y my-2 border-black w-full flex gap-2">
            ...
            <div className="w-full flex justify-between gap-2">
                ...
                <div className="flex content-baseline my-auto gap-1 justify-end">
                    <h1 className="font-bold text-md md:text-lg mx-2 md:mx-4 my-auto align-middle">{(props.price * amount).toFixed(2)}€</h1>
                    <input className="w-10 flex-none text-center border-b border-black" size={2} type="number" value={amount} onChange={(e) => {if(Number(e.target.value) > props.amountInStock){
